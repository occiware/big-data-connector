 ...
 * - title: 
 */
public class HdfsConnector extends org.occiware.bigdata.impl.HdfsImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(HdfsConnector.class);

	// Start of user code Hdfsconnector_constructor
	/**
	 * Constructs a hdfs connector.
	 */
	HdfsConnector()
	{
